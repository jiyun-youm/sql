...
SELECT * FROM EMPLOYEES WHERE DEPARTMENT_ID LIKE '50';
SELECT FIRST_NAME, LAST_NAME, DEPARTMENT_ID, SALARY+300 FROM EMPLOYEES;
...
SELECT FIRST_NAME, LAST_NAME, SALARY FROM EMPLOYEES WHERE DEPARTMENT_ID LIKE '60' ORDER BY SALARY DESC;
SELECT FIRST_NAME, LAST_NAME, JOB_ID FROM EMPLOYEES WHERE JOB_ID LIKE 'IT_PROG' OR JOB_ID LIKE 'SA_MAN' ;
SELECT '"'||FIRST_NAME||' '||LAST_NAME||'사원의 급여는 '||SALARY||'달러 입니다' FROM EMPLOYEES WHERE EMPLOYEE_ID LIKE '100' ;
